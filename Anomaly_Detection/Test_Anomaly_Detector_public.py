...
AllTest_Video_Path = 'SampleVideos'
...
for iv in range(nVideos):
    ...
    aa=aa[0:-4]
    A_predictions_path = Results_Path + aa + '.txt'  # Save array of 1*32, containing anomaly score for each segment. Please see Evaluate Anomaly Detector to compute  ROC.
    np.savetxt(A_predictions_path, predictions)
